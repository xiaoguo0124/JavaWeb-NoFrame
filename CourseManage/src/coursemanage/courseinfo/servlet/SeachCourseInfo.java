...
/**
 * Servlet implementation class SeachCourseInfo
 */
@WebServlet("/SeachCourseInfo")
public class SeachCourseInfo extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SeachCourseInfo() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<CourseInfo> clist=cs.getCourseInfo(ci);
